...
class AvatarImage extends StatelessWidget {
  const AvatarImage(this.name, {this.width = 90, this.height = 90, this.bgColor, this.borderWidth = 0, this.borderColor, this.trBackground = false, this.isSVG = true, this.radius = 50});
  final String name;
  final double width;
  final double height;
